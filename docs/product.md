...
사용자는 엽석연, 탈피·아바루스, 미아즈믹·도플갱어의 코마노 마나토·제인·「변절자」를 1순위 조사 대상으로 합의했다. 보스 선정은 구체적 패턴이나 서비스 채택의 확정이 아니다. 각 대상의 연습할 연속 동작·범위·필요 입력을 외부 영상과 내부 구현에서 선별하며, 마지막 성공 처리에 전체 패링 누적 조건이 없다는 이유만으로 앞선 연속 수행의 학습 가치를 배제하지 않는다. 조사 담당과 현재 결과 경로는 README를 따른다. 태양의 잔불 실험은 병렬로 유지한다.
